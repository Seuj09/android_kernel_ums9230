...
/* this tree keeps page->mem_cgroup as a direct field, no folio rework yet.
 * page_memcg()/page_memcg_rcu() already exist in linux/mm.h -- only the
 * trylock/unlock pair below is new.
 */
