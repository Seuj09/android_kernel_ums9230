...
/* 5.4 adapt: classic spin_lock_irqsave (no cleanup.h), embedded
 * bitmap_tags, 3-arg try_insert_merge + free list, prepare_request(bio).
 * Donor: Pzqqt marble through flush/FUA + folded 3.3.0. */
